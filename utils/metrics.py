...
class WIoU_Scale:
   ''' 
   - monotonous = None cho WIouv1
   - monotonous = True cho WIouv2
   - monotonous = False cho WIouv3

   '''

   # Giá trị trung bình IoU, Default theo paper = 1.0
   iou_mean = 1.

   # Chỉnh phần này để đổi version WIoU
   monotonous = True

   # Momentum coefficient
   _momentum = 1 - 0.5 ** (1 / 7000)

   # Mark whether it is training mode
   _is_train = True
   ...
   def _scaled_loss(cls, self, gamma=1.9, delta=3):
       # Adjust the loss calculation method according to the value of monotonous
